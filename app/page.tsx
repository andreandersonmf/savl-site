              ...
              >
                {siteProfile ? (
                  ...
                  <div className="mb-5 rounded-[1.5rem] border border-white/10 bg-white/5 p-4 text-sm text-white/60">
                    Optional: <Link href="/login" className="font-semibold text-emerald-300 underline decoration-emerald-300/30">login with Discord</Link> to connect this registration to your SAVL profile.
                  </div>
                )}
